def xlsx_to_docx():
    ...
    base_path = 'services/xlsx_to_docx'
    base_input_path = os.path.abspath(f'{base_path}/xlsx_to_docx_input')
    base_output_path = os.path.abspath(f'{base_path}/xlsx_to_docx_output')
